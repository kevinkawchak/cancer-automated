...
{\footnotesize
\begin{xltabular}{\textwidth}{@{}L{3.5cm} Y L{3.0cm}@{}}
\hline
...
Gates 01, 08; the gate credibility basis\\
\hline
...
06, 07\\
\hline
ISO 14971 & Risk management; risk control verification & Gate 06; the hard
predicate as a risk limit\\
\hline
...
10; cybersecurity and lifecycle\\
\hline
...
\hline
21 CFR part 11 & Electronic-record integrity & The hash-chained audit trail in
subsection (e)\\
\hline
\end{xltabular}}
\figcaption{Table 5. External standards map: the recognized consensus standards
bound to the gates and duties of section 515D, with the gate or duty each
governs.}
