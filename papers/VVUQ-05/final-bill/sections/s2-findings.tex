...
the precise amendment (VVUQ-04), each released to a DOI.}
...
\hline\noalign{\vskip 0.04cm}
\endlastfoot
VVUQ-01 & Method paper plus working pipeline and an execution record, holding
...
\hline\noalign{\vskip 0.04cm}
VVUQ-02 & Generated ten-gate humanoid surgical codebase, autonomous
execution record, and manuscript & v0.7.0 to v1.2.0 & 172 of
...
\hline\noalign{\vskip 0.04cm}
VVUQ-03 & Standalone Physical AI Oncology Trial Bill (H. R. 9510),
...
\hline\noalign{\vskip 0.04cm}
VVUQ-04 & Bill recast as an amendment to the Federal Food, Drug, and
Cosmetic Act, through Public Law 119-93 & v2.0.0 to v2.3.0 & New section
...
record-integrity scaffolding but with no rule that verification precedes
