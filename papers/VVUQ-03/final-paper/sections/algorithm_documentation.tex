...
\begin{table}[ht]
\centering
\begin{tabularx}{\textwidth}{L{4.25cm} Y L{2.0cm}}
\toprule
...
(3) Training data & Description of data sets used to train the model & \cite{ny-a9149, ca-sb1120} \\
...
h2\_hand\_kinematics.md & Dexterous-hand kinematics behind force, grasp gates \\
...
\multicolumn{2}{l}{\textbf{papers/VVUQ-02/codegen/config/}} \\
...
\midrule
\multicolumn{2}{l}{\textbf{papers/VVUQ-02/codegen/results/comparison.json}} \\
Size and shape & 1{,}790 lines; 32 iterations; four rounds per iteration \\
Determinism & Seed 20260525; regenerates byte for byte \\
Entrant 1 & H2\_Surgical\_1\_0, the single mobile surgical humanoid (hypothetical) \\
...
\midrule
\multicolumn{2}{l}{\textbf{VVUQ-02/codegen/data/sample\_h2\_sensor.csv}} \\
