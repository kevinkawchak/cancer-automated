...
its Physical AI Standard Level gate.

Also, each robot met the Unification Standard
...
consistent with the credibility framework \cite{fda2023credibility,
kawchak2026vvuq02}.
...
\toprule
\textbf{Attestation clause} & \textbf{Evidencing artifact} & \textbf{Answers to} \\
\midrule
\multicolumn{3}{l}{\textbf{papers/VVUQ-02/codegen/docs/}} \\
Verification cleared first & vvuq\_gate\_spec.md & ASME V\&V 40 § 8; verif. fraction 1.0 \\
Gate bound to a standard & standards\_map.md & IEC 80601-2-77; ISO 14971; per gate \\
CI and tests pass & ci\_compliance\_checklist.md & IEC 62304; 172 tests; Python 3.10 to 3.12 \\
\multicolumn{3}{l}{\textbf{physical-ai .../final\_paper/sections/}} \\
PSL and USL gates pass & psl\_usl\_standards.tex & Site PSL; robot USL minimum \\
\bottomrule
\end{tabularx}
