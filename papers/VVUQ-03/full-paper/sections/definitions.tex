...
\begin{xltabular}{\textwidth}{L{2.7cm} Y L{2.5cm}}
\toprule
...
\bottomrule
\endlastfoot
\multicolumn{3}{l}{\textit{Block 1: Statutory technical terms}} \\
...
Algorithm & A defined computational procedure that maps inputs to outputs; under this bill, any procedure governing a robot-patient interaction. & \cite{cfr-devices} \\
...
\multicolumn{3}{l}{\textit{Block 2: Verification, validation, and uncertainty quantification}} \\
Verification & Confirmation that the code was built correctly, that is, the implementation conforms to its specification. & \cite{asmevv40} \\
...
Uncertainty quantification & Measurement of how confident a result is across repeated runs, expressed as statistical dispersion. & \cite{nasastd7009a} \\
...
ACCEPT, BLOCK, ESCALATE & The three-way gate decision; any single failing dimension blocks, and ambiguity or divergence escalates and hands back to a human. & \cite{kawchak2026vvuq02} \\
...
\multicolumn{3}{l}{\textit{Block 3: Unification and Physical AI Standard Levels}} \\
...
\multicolumn{3}{l}{\textit{Block 4: Physical AI system terms}} \\
...
Robot agent & An autonomous Physical AI system executing trial procedures through protocol-mediated data access under a defined authenticate-retrieve-execute-record workflow. & \cite{kawchak2026mcp} \\
...
Simulation framework & A physics-based computational environment used to validate robot behavior before clinical use. & \cite{kawchak2026national} \\
Cross-framework tolerances & The consistency bounds across at least two simulation frameworks: trajectory deviation under 2 mm and force discrepancy under 0.5 N. & \cite{kawchak2026national} \\
...
Hash-chained audit trail & An immutable, tamper-evident SHA-256-linked record of every system action, satisfying the electronic-records integrity of 21 CFR Part 11. & \cite{cfr-part11} \\
\end{xltabular}
...
statement of where the ecosystem is least certain. The bill therefore treats USL
