...
\begin{xltabular}{\textwidth}{L{3.2cm} L{1.5cm} L{1.3cm} L{1.5cm} Y}
\toprule
...
10 Fault, e-stop, degradation & 1.00 & 0.05 & Yes & IEC 60601-1; ISO 13849-1; IEEE 7009 \\
\end{xltabular}
...
cryptographically signed audit trail that satisfies the electronic-records rule
