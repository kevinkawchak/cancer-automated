...
bibliography entry so the rendered reference carries the eCFR, Cornell LII, or
...
Devices \cite{cfr-devices} & 21 CFR Parts 860 to 892 & Robot and software device documentation framing \\
...
FD\&C Act \cite{usc-fdca} & 21 U.S.C. § 301 et seq. & Statutory basis for FDA authority over the trial \\
PHSA \cite{usc-phsa} & 42 U.S.C. § 201 et seq. & Public-health and biologics oversight \\
Electronic records \cite{cfr-part11} & 21 CFR Part 11 & Trustworthy electronic records and signatures \\
IND pathway \cite{cfr-part312} & 21 CFR Part 312 & Trial-conduct frame the gate attaches to \\
Human subjects \cite{cfr-part50} & 21 CFR Part 50 & Human-subject protection extended to robot contact \\
\bottomrule
\end{tabularx}
...
state-and-federal jurisdiction treatment is drawn from the national platform's
regulatory-landscape analysis \cite{kawchak2026national}.

\begin{table}[ht]
\centering
\begin{tabularx}{\textwidth}{L{2.6cm} Y L{3.3cm}}
\toprule
\textbf{State and bill} & \textbf{State requirement} & \textbf{Informs which clause} \\
\midrule
New York A9149 \cite{ny-a9149} & Submit AI algorithms and training data for certification of minimized bias and evidence-based guidelines & Documentation and nondiscrimination clauses \\
...
Section~\ref{sec:section_by_section}, completes the mapping from these adaptations
to the enactable text.
...
\midrule
21 CFR Part 312 \cite{kawchak2026cfr312} & Structural template; cover, style, and the new-subpart model for statutory text \\
