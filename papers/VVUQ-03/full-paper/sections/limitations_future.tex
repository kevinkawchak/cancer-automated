...
references rather than a full physics engine. Local execution used a single
...
Offline web and PDF ingestion (execution READMEs) & Connect live retrieval; re-ingest the full corpus \\
No physics engine installed (VVUQ-02 limits) & Run behaviors under a full physics engine \\
