# Chunk 11 — BibTeX References Part 2: GitHub Repositories, Third-Party Literature, FDA/Introduction References
...
@article{benary2023leveraging,
  ...
  author={Benary, Manuela and Wang, Xing David and Schmidt, Max and Soll, Dominik and Hilfenhaus, Georg and Nassir, Mani and Sigler, Christian and Knödler, Maren and Keller, Ulrich and Beule, Dieter and others},
...
@misc{01IntroFDA2023, title={Assessing the Credibility of Computational Modeling and Simulation in Medical Device Submissions}, url={https://www.fda.gov/regulatory-information/search-fda-guidance-documents/assessing-credibility-computational-modeling-and-simulation-medical-device-submissions}, abstractNote={This guidance document provides the FDA's recommendations on a risk-informed framework for credibility assessment of computational modeling and simulation (CM&S) used in medical device regulatory submissions.}, author={Health, Center for Devices and Radiological}, year={2023}, month=nov, language={en} }

@misc{02IntroFDA2025, title={M15 General Principles for Model-Informed Drug Development}, url={https://www.fda.gov/regulatory-information/search-fda-guidance-documents/m15-general-principles-model-informed-drug-development}, abstractNote={M15 General Principles for Model-Informed Drug Development}, author={Research, Center for Drug Evaluation and}, year={2025}, month=jan, language={en} }

@article{03IntroMadabushi, title={Review: Role of Model-Informed Drug Development Approaches in the Lifecycle of Drug Development and Regulatory Decision-Making}, volume={39}, ISSN={1573-904X}, url={https://doi.org/10.1007/s11095-022-03288-w}, DOI={10.1007/s11095-022-03288-w}, number={8}, journal={Pharmaceutical Research}, author={Madabushi, Rajanikanth and Seo, Paul and Zhao, Liang and Tegenge, Million and Zhu, Hao}, year={2022}, month=aug, pages={1669–1680}, language={en} }

@article{04IntroCraig, title={A practical guide for the generation of model-based virtual clinical trials}, volume={3}, ISSN={2674-0702}, url={https://www.frontiersin.org/journals/systems-biology/articles/10.3389/fsysb.2023.1174647/full}, DOI={10.3389/fsysb.2023.1174647}, journal={Frontiers in Systems Biology}, author={Craig, Morgan and Gevertz, Jana L. and Kareva, Irina and Wilkie, Kathleen P.}, year={2023}, month=jun, language={English} }

@article{05IntroGalluppi, title={Considerations for Industry—Preparing for the FDA Model-Informed Drug Development (MIDD) Paired Meeting Program}, volume={116}, ISSN={0009-9236, 1532-6535}, url={https://ascpt.onlinelibrary.wiley.com/doi/10.1002/cpt.3245}, DOI={10.1002/cpt.3245}, number={2}, journal={Clinical Pharmacology & Therapeutics}, author={Galluppi, Gerald R. et al.}, year={2024}, month=aug, pages={282–288}, language={en} }
```
