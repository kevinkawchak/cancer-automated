...
automated day count mean of 12.0000 with a standard deviation of 0.0816. The
...
\centering
\begin{tabularx}{\textwidth}{C{1.0cm} L{6.0cm} C{1.9cm} C{1.5cm} >{\raggedright\arraybackslash}X}
\toprule
