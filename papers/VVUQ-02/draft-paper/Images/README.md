...
draft compiles cleanly in Overleaf without these files.
...
`main.tex` looks there). Without it, the template shows a green `iD` glyph linked
to the ORCID record, which is the default styling for this template family.
